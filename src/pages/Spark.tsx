...
export default function Spark() {
  return (
    <div className="space-y-4">
      ...
      <SectionPanel compact title="Cluster Overview (spark-prod)">
      ...
      <SectionPanel compact title="Spark Cluster Overview">
      ...
      <SectionPanel compact title="Applications / Jobs">
        <StatusDataTable columns={sparkAppJobColumns} data={sparkAppJobRows} />
      </SectionPanel>

      <SectionPanel compact title="Executor State">
      ...
      <div className="grid grid-cols-2 gap-4">
        <SectionPanel compact title="Running / Completed / Failed Stages">
      ...
      <SectionPanel compact title="Top Running Stages">
        <StatusDataTable columns={sparkTopStagesColumns} data={sparkTopStagesRows} />
      </SectionPanel>

      <SectionPanel compact title="Cluster Resource Usage">
        <TrendLineChart {...sparkResourceTrend} height={260} />
      </SectionPanel>

      {/* 4-10: Spark SQL/ETL 처리량 */}
      <SectionPanel compact title="Spark SQL/ETL Throughput">
      ...
      {/* 4-13: 튜닝 & 헬스 지표 */}
      <div className="grid grid-cols-2 gap-4">
        <SectionPanel compact title="Cache Hit Ratio">
          <GaugeRing {...sparkTuningGauges.cacheHitRatio} height={200} />
        </SectionPanel>
        <SectionPanel compact title="Broadcast Join Usage">
