...
export default function Kafka() {
  return (
    <div className="space-y-4">
      ...
      <SectionPanel compact title="Cluster Overview (kafka-prod)">
      ...
      <SectionPanel compact title="Topics">
      ...
      {/* 3-9: 리소스 사용량 */}
      <div className="grid grid-cols-2 gap-4">
        <SectionPanel compact title="Broker Disk Usage (%)">
          <BarChart {...kafkaDiskUsageBar} height={220} />
        </SectionPanel>
        <SectionPanel compact title="Network Usage (MB/s)">
